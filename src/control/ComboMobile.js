...
;(function(){
    ...
    function ComboMobile(pano){
        //this.options = P.extend(this.options,opts);
        this.pano = pano;
        this.ctor();
    }

    ComboMobile.prototype = {
        options : {
        ...
        ctor:function(){
            ...
            this.wrap = P.dom.create('div',null,null,'position:absolute;left:0;bottom:0;height:110px;width:100%;',this.album);
            ...
            this.tm.innerHTML = '<ul style="display:none"><li>春季</li><li>夏季</li><li>秋季</li><li>冬季</li></ul>';

            console.log('wrap_'+this._stamp)


            var map_id = 'map_container'+ "_" + new Date().getTime() + "_" +Math.round(Math.random()*300);
            this.map_container = P.dom.create('div',map_id,'pax-map','',this.el);
        ...
        setNav : function(){
            ...
            var p = new BMap.Point(position.lng , position.lat);
    ...
    P.Control.ComboMobile = ComboMobile;
    P.control.comboMobile = function(opts){
        return new ComboMobile(opts)
    }
}());
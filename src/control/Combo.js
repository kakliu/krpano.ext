...
;(function(){
    ...
    Combo.prototype = {
        ...
        ctor:function(){
            ...
            this.cont = P.dom.create('div',null,'','position: relative;height: 100%;overflow:hidden;margin-left: 250px;',this.album);
            ...
            this.tm.innerHTML = '<span>时光机</span><ul style="display:none"><li>春季</li><li>夏季</li><li>秋季</li><li>冬季</li></ul>';
        ...
        setNav : function(){
            ...
            console.log(this.pano.panoData)
        ...
        _bind : function(){
            ...
            $(this.wrap).on("click",'li' , function(){
                ...
                vw = $(container).width();console.log(vw)
                if(width > vw)
                    active = true;
    ...
    P.Control.Combo = Combo;
    P.control.combo = function(opts){
        return new Combo(opts)
    }
}());